...
<head>
  ...
  <script type="text/javascript" src="<%=basePath%>js/spCluster.js"></script>
...
<script type="text/javascript">
  function initialize() {
    loadMap();
    $.getJSON("<%=basePath%>mapServlet?cmd=6",function (data) {
      showStayPoint(data);
    ...
    $.getJSON("<%=basePath%>mapServlet?cmd=5",function (data){
      showGrid(data);
    });

    $.getJSON("<%=basePath%>mapServlet?cmd=4",function (data){
      showSPClusters(data);
    });
  }
  function loadScript() {
